...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="bg-[#101018] py-24">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-white mb-14 text-center">
        ...
        <div className="lg:hidden">
          <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory">
            {testimonials.map((testimonial, index) => (
              <div
                key={testimonial.author}
                className="fade voxel card3d rounded-lg p-6 ring-1 ring-white/10 shadow-xl min-w-[280px] snap-start"
                style={{ animationDelay: testimonial.delay }}
              >
                <div className="flex items-start gap-4 mb-4">
                  <div
